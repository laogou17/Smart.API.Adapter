...
namespace NEOCRM.Api
{
	...
	{
		/// <summary>
		/// 初始化 <see cref="NEOCRM.Api.ApiError"/> 类的新实例。
		/// </summary>
		public ApiError()
		{
		...
		/// <summary>
		/// 使用指定的错误代码与错误消息初始化 <see cref="NEOCRM.Api.ApiError"/> 类的新实例。
		/// </summary>
	...
	public class ApiException : ApplicationException
	{
		...
		/// <summary>
		/// 初始化 NEOCRM.Api.ApiException 类的新实例。
		/// </summary>
		public ApiException()
			: base()
		{
		...
		/// <summary>
		/// 使用指定错误消息初始化 NEOCRM.Api.ApiException 类的新实例。
		/// </summary>
		...
		/// <summary>
		/// 使用指定错误消息和错误代码来初始化 NEOCRM.Api.ApiException 类的新实例。
		/// </summary>
		/// <param name="message">解释异常原因的错误信息。</param>
		...
		/// <summary>
		/// 使用指定错误消息、错误代码和对作为此异常原因的内部异常的引用来初始化 NEOCRM.Api.ApiException 类的新实例。
		/// </summary>
		/// <param name="message">解释异常原因的错误信息。</param>
		/// <param name="errorCode">解释异常原因的错误代码。</param>
	...
	public class ArgumentException : ApiException
	{
		...
		/// <summary>
		/// 初始化 NEOCRM.Api.ArgumentException 类的新实例。
		/// </summary>
		...
		/// <summary>
		/// 使用指定错误消息来初始化 NEOCRM.Api.ArgumentException 类的新实例。
		/// </summary>
		/// <param name="message">解释异常原因的错误信息。</param>
		...
		/// <summary>
		/// 使用指定错误消息和错误代码来初始化 NEOCRM.Api.ArgumentException 类的新实例。
		/// </summary>
		/// <param name="message">解释异常原因的错误信息。</param>
		/// <param name="errorCode">解释异常原因的错误代码。</param>
	...
	{
		/// <summary>
		/// 初始化 NEOCRM.Api.InvalidSignException 类的新实例。
		/// </summary>
		...
		/// <summary>
		/// 使用指定错误消息和错误代码来初始化 NEOCRM.Api.InvalidSignException 类的新实例。
		/// </summary>
		/// <param name="message">解释异常原因的错误信息。</param>
		/// <param name="errorCode">解释异常原因的错误代码。</param>
	...
	{
		/// <summary>
		/// 初始化 NEOCRM.Api.NoAccessRightException 类的新实例。
		/// </summary>
		...
		/// <summary>
		/// 使用指定错误消息来初始化 NEOCRM.Api.NoAccessRightException 类的新实例。
		/// </summary>
		/// <param name="message">解释异常原因的错误信息。</param>
		...
		/// <summary>
		/// 使用指定错误消息和错误代码来初始化 NEOCRM.Api.NoAccessRightException 类的新实例。
		/// </summary>
		/// <param name="message">解释异常原因的错误信息。</param>
		/// <param name="errorCode">解释异常原因的错误代码。</param>
	...
	{
		/// <summary>
		/// 初始化 NEOCRM.Api.AccessFrequencyException 类的新实例。
		/// </summary>
		...
		/// <summary>
		/// 使用指定错误消息来初始化 NEOCRM.Api.AccessFrequencyException 类的新实例。
		/// </summary>
		/// <param name="message">解释异常原因的错误信息。</param>
